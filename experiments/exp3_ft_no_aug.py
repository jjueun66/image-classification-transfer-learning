...
def main():
    ...
    exp_name = "exp3_ft_no_aug"

    # 1) DataLoader (augmentation=False)
    ...
    for epoch in range(num_epochs):
        ...
        print(f"[Exp3][{epoch+1:02d}/{num_epochs}] Train Acc: {tr_acc:.4f} | Val Acc: {va_acc:.4f}")
    ...
    print(f"[Exp3] Best Val Acc: {best_val_acc:.4f}")
    print(f"[Exp3] Test Acc: {test_acc:.4f}")

...
def main():
    ...
    exp_name = "exp2_base_aug"

    # 1) DataLoader (augmentation=True)
    ...
    for epoch in range(num_epochs):
        ...
        print(f"[Exp2][{epoch+1:02d}/{num_epochs}] Train Acc: {tr_acc:.4f} | Val Acc: {va_acc:.4f}")
    ...
    print(f"[Exp2] Best Val Acc: {best_val_acc:.4f}")
    print(f"[Exp2] Test Acc: {test_acc:.4f}")

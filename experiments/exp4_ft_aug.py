...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        print(f"[Exp4][{epoch+1:02d}/{num_epochs}] Train Acc: {tr_acc:.4f} | Val Acc: {va_acc:.4f}")
    ...
    print(f"[Exp4] Best Val Acc: {best_val_acc:.4f}")
    print(f"[Exp4] Test Acc: {test_acc:.4f}")
